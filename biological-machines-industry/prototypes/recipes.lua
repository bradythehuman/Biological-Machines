...
dh.add_ingredient("low-density-structure", "item", "copper-plate", 8)

dh.add_ingredient("low-density-structure", "item", "plastic-bar", 8)

dh.remove_ingredient("casting-low-density-structure", "molten-iron")
dh.add_ingredient("casting-low-density-structure", "fluid", "bm-molten-steel", 160)
dh.add_ingredient("casting-low-density-structure", "fluid", "molten-copper", 100)
