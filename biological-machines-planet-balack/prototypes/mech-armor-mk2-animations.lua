...
local function mech_anim(name, table, light)
  ...
  table.scale = table.scale or (0.5 * 1.25)
  local mask_table = {}
  local light_table = {}
  local shadow_table = {}
...
data.raw['character-corpse']['character-corpse'].armor_picture_mapping["bm-mech-armor-mk2"] = #data.raw['character-corpse']['character-corpse'].pictures
